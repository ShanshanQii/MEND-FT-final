...
!            sPARbase%KsMOM      = xx(6)*xx(7)*0.8  !! MOM decomposition,  *0.8
        ...
        wp_scalar = fSWP(wp, BIOME, SOM)
        pH_scalar = fpH(sCase,pH)
        ! sPAR % VdMOM        = sPARbase % VdMOM*pH_scalar*wp_scalar*tp_scalar ![mg MOM/mg ENZMAOC/h], maximum reaction rate for conversion of MAOC by ENZMAOC xx(5)
        ...
        !        tp_scalar = fTQ10_MEND(sCase,tp, const_Tref, sPAR % Q10)
        !    end if
        ! sPAR % VmA2D = sPARbase%Vm*tp_scalar*wp_scalar_low!!mark0306
        ...
        ! sPAR % VNit     = sPARbase % Vnit*wp_scalar_opt*tp_scalar !!xx(31)
        ...
        !    end if
        wp_scalar_opt   = fWFP_PieceWise(sCase,wfp)
        ! sPAR % VDenit(1)   = sPARbase % VDenit(1)*wp_scalar_opt*tp_scalar  !!xx(32)
